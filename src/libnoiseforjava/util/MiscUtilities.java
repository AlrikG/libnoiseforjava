...
public class MiscUtilities {
     ...
     * @return
     */
    public static ColorCafe linearInterpColor(ColorCafe color0, ColorCafe color1, float alpha) {
        ColorCafe color = new ColorCafe(blendChannel(color0.red, color1.red, alpha), blendChannel(color0.green, color1.green, alpha), blendChannel(
                color0.blue, color1.blue, alpha), blendChannel(color0.alpha, color1.alpha, alpha));
        return color;
    }
