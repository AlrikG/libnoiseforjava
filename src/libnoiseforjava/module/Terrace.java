 ...
 * resets the slope to zero at that point, producing a "terracing" effect. Refer
 * to the following illustration:
 * 
 * <p>
 * <img src="http://libnoise.sourceforge.net/docs/moduleterrace.png">
 * 
 * <p>
 ...
 * 
 * @see <a
 *      href="http://libnoise.sourceforge.net/docs/classnoise_1_1module_1_1Terrace.html">noise::module:Terrace</a>
 */
public class Terrace extends ModuleBase {
    ...
    public double getValue(double x, double y, double z) {
        ...
        int index1 = Misc.ClampValue(indexPos, 0, this.controlPointCount - 1);
     ...
     * inverted.
     *
     * @return - @a true if the curve between the control points is inverted. - @a
