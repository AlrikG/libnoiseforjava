 ...
 * 
 * @see <a
 *      href="http://libnoise.sourceforge.net/docs/classnoise_1_1module_1_1Min.html">noise::module:Min</a>
 */
public class Min extends ModuleBase {

    public Min(ModuleBase sourceModuleOne, ModuleBase sourceModuleTwo) throws IllegalArgumentException {
        super(2);
