 ...
 * (unless I absolutely need the speed.)
 * 
 * <p>
 ...
 * called <i>gradient noise</i>. This version of the Perlin module uses gradient
 * coherent noise to generate Perlin noise.
 * 
 * @see <a
 *      href="http://libnoise.sourceforge.net/docs/classnoise_1_1module_1_1Perlin.html">noise::module:Perlin</a>
 */
public class Perlin extends ModuleBase {
     ...
     * 
     * <p>
     * For best results, set the lacunarity to a number between 1.5 and 3.5 (~2
     * is best).
     * 
