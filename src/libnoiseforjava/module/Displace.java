 ...
 * 
 * <p>
 * <img src="http://libnoise.sourceforge.net/docs/moduledisplace.png">
 * 
 * <p>
 ...
 * apply to the @a y coordinate of the input value.
 * <li>Source module 3 (lower right in the diagram) specifies the offset to
 * apply to the @a z coordinate of the input value.
 * </ul>
 ...
 * 
 * <p>
 * The Turbulence noise module is a special case of the Displace module;
 * internally, there are three Perlin-noise modules that perform the
 ...
 * 
 * @see <a
 *      href="http://libnoise.sourceforge.net/docs/classnoise_1_1module_1_1Displace.html">noise::module:Displace</a>
 */
public class Displace extends ModuleBase {

    public Displace(ModuleBase sourceModuleOne, ModuleBase sourceModuleTwo, ModuleBase sourceModuleThree, ModuleBase sourceModuleFour) throws IllegalArgumentException {
        super(4);
    ...
    public double getValue(double x, double y, double z) {
        ...
        assert (this.sourceModules[3] != null);
     ...
     *
     * @throw ExceptionNoModule See the preconditions for more information.
     *
     *        The getValue() method displaces the input value by adding the
     *        output value from this displacement module to the @a y coordinate
     ...
     *
     *        The getValue() method displaces the input value by adding the
     *        output value from this displacement module to the @a z coordinate
     *        of the input value before returning the output value from the
     *        source module.
     */
     ...
     *
     *            The getValue() method displaces the input value by adding the
     *            output value from each of the displacement modules to the
     *            corresponding coordinates of the input value before returning
     *            the output value from the source module.
     *
     *            This method assigns an index value of 1 to the @a x
     *            displacement module, an index value of 2 to the @a y
     *            displacement module, and an index value of 3 to the @a z
     *            displacement module.
     *
     *            These displacement modules must exist throughout the lifetime
     *            of this noise module unless another displacement module
     *            replaces it.
     */
    public void setDisplaceModules(ModuleBase xDisplaceModule, ModuleBase yDisplaceModule, ModuleBase zDisplaceModule) {
     ...
     *
     *            The getValue() method displaces the input value by adding the
     *            output value from this displacement module to the @a x
     *            coordinate of the input value before returning the output
     *            value from the source module.
     *
     *            This method assigns an index value of 1 to the @a x
     *            displacement module. Passing this displacement module to this
     *            method produces the same results as passing this displacement
     *            module to the setSourceModule() method while assigning it an
     *            index value of 1.
     *
     *            This displacement module must exist throughout the lifetime of
     *            this noise module unless another displacement module replaces
     *            it.
     */
    public void setXDisplaceModule(ModuleBase xDisplaceModule) {
        assert (this.sourceModules != null);
        this.sourceModules[1] = xDisplaceModule;
    }
     ...
     *
     *            The getValue() method displaces the input value by adding the
     *            output value from this displacement module to the @a y
     *            coordinate of the input value before returning the output
     *            value from the source module.
     *
     *            This method assigns an index value of 2 to the @a y
     *            displacement module. Passing this displacement module to this
     *            method produces the same results as passing this displacement
     *            module to the setSourceModule() method while assigning it an
     *            index value of 2.
    ...
    public void setYDisplaceModule(ModuleBase yDisplaceModule) {
        assert (this.sourceModules != null);
        this.sourceModules[2] = yDisplaceModule;
    }
     ...
     *
     *            The getValue() method displaces the input value by adding the
     *            output value from this displacement module to the @a z
     *            coordinate of the input value before returning the output
     *            value from the source module.
     *
     *            This method assigns an index value of 3 to the @a z
     *            displacement module. Passing this displacement module to this
     *            method produces the same results as passing this displacement
     *            module to the setSourceModule() method while assigning it an
     *            index value of 3.
    ...
    public void setZDisplaceModule(ModuleBase zDisplaceModule) {
        assert (this.sourceModules != null);
        this.sourceModules[3] = zDisplaceModule;
    }
}
