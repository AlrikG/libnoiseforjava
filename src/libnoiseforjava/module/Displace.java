 ...
 * <li>Source module 1 (lower left in the diagram) specifies the offset to
 *   apply to the @a x coordinate of the input value.
 * <li>Source module 2 (lower center in the diagram) specifies the
 *   offset to apply to the @a y coordinate of the input value.
 * <li>Source module 3 (lower right in the diagram) specifies the offset
 ...
 * 
 * @see <a href="http://libnoise.sourceforge.net/docs/classnoise_1_1module_1_1Displace.html">noise::module:Displace</a>
 */
