 ...
 * 
 * @see <a href="http://libnoise.sourceforge.net/docs/classnoise_1_1module_1_1Voronoi.html">noise::module:Voronoi</a>
 */
public class SimplexVoronoi extends ModuleBase
{
	...
	public SimplexVoronoi()
	{
		...
		noisesource = new SimplexBasis[3];
	}
	...
	public void build()
	{
		for( int i = 0; i < 3; i++)
		{
			noisesource[i] = new SimplexBasis();
			noisesource[i].setSeed(seed + i);
		}
	}
	 ...
	 * @returns
	 * <ul>
	 * <li> true if the distance is applied to the output value.
	 * <li> false if not.
	 * </ul>
	 */
